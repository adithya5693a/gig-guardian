...
const extraTranslations: Partial<Record<Language, Record<string, string>>> = {
  hi: {
    ...
    "Accept job": "काम स्वीकारें",
    "Decline job": "काम ठुकराएँ",
    "Job declined — not logged.": "काम ठुकराया गया — दर्ज नहीं किया गया।",
    Dashboard: "डैशबोर्ड",
  ...
  kn: {
    ...
    "Decline job": "ಕೆಲಸ ನಿರಾಕರಿಸಿ",
    "Job declined — not logged.": "ಕೆಲಸ ನಿರಾಕರಿಸಲಾಗಿದೆ — ದಾಖಲಾಗಿಲ್ಲ.",
    Dashboard: "ಡ್ಯಾಶ್‌ಬೋರ್ಡ್",
  ...
  ta: {
    ...
    "Accept job": "வேலையை ஏற்கவும்",
    "Decline job": "வேலையை மறுக்கவும்",
    "Job declined — not logged.": "வேலை நிராகரிக்கப்பட்டது — பதிவு செய்யப்படவில்லை.",
    Dashboard: "டாஷ்போர்டு",
  ...
  te: {
    ...
    "Accept job": "ఉద్యోగాన్ని అంగీకరించండి",
    "Decline job": "ఉద్యోగాన్ని తిరస్కరించండి",
    "Job declined — not logged.": "ఉద్యోగం తిరస్కరించబడింది — నమోదు కాలేదు.",
    Dashboard: "డాష్‌బోర్డ్",
  ...
  mr: {
    ...
    "Decline job": "काम नाकारा",
    "Job declined — not logged.": "काम नाकारले — नोंदवले नाही.",
    Dashboard: "डॅशबोर्ड",
    "Daily savings plan": "दैनिक बचत योजना",
    "Daily target": "दैनिक लक्ष्य",
  ...
  bn: {
    ...
    "Accept job": "কাজ গ্রহণ করুন",
    "Decline job": "কাজ প্রত্যাখ্যান করুন",
    "Job declined — not logged.": "কাজ প্রত্যাখ্যান করা হয়েছে — লগ করা হয়নি।",
    Dashboard: "ড্যাশবোর্ড",
