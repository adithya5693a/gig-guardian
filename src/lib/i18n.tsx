...
const translations = {
  ...
  ta: {
    ...
    aiChat: "AI அரட்டை",
    checkOffer: "சலுகையைச் சரிபார்க்கவும்",
    language: "மொழி",
    chatTitle: "AI அரட்டை",
  ...
  te: {
    ...
    aiChat: "AI చాట్",
    checkOffer: "ఆఫర్‌ని తనిఖీ చేయండి",
    language: "భాష",
    chatTitle: "AI చాట్",
